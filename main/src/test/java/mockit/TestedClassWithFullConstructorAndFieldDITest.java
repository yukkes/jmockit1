...
public final class TestedClassWithFullConstructorAndFieldDITest
{
    ...
    */
   static class DependencyWithFieldDIOnly { /** The value. */
 String value; }
   ...
   /**
    * Verify each target field gets injected with first unused injectable whether through field or constructor injection.
    */
   @Test
    ...
    */
   static class ClassWithFieldToInject { /** The dependency. */
 ClassWithMultipleConstructors dependency; }
    ...
    */
   static class ClassWithFieldDI { /** The dep. */
 Dependency dep; }
