...
public final class MockUpTest {
    ...
    public void mockUpGivenClass() {
        ...
        AtomicIntegerFieldUpdater<?> atomicCount = Deencapsulation.getField(Main.class,
    ...
    public void callEqualsMethodOnMockedUpInterface() {
        SomeInterface proxy1 = new MockUp<SomeInterface>() {
        }.getMockInstance();
        SomeInterface proxy2 = new MockUp<SomeInterface>() {
        }.getMockInstance();
    ...
    public void callHashCodeMethodOnMockedUpInterface() {
        SomeInterface proxy = new MockUp<SomeInterface>() {
        }.getMockInstance();
    ...
    public void mockSameClassTwiceUsingSeparateMockups() {
        ...
        class MockUp1 extends MockUp<Applet> {
            @Mock
            void play(URL url) {
            }
        }
    ...
    // TODO Method return value is undefined.
    @Ignore("Method return value is undefined")
    @Test
    public void mockSameInterfaceTwiceUsingSeparateMockups() {
        class MockUp1 extends MockUp<C> {
            @Mock
            int method1() {
                return 1;
            }
