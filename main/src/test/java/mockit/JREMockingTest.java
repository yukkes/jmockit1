...
public final class JREMockingTest
{
    ...
    *
    * @param unmockable the unmockable
    */
    ...
    * Attempt to mock unmockable JRE interface.
    *
    * @param mockSortedSet the mock sorted set
    */
   @Test(expected = IllegalArgumentException.class)
    ...
    * Attempt to mock unmockable JRE interface.
    *
    * @param mockSortedMap the mock sorted map
    */
   @Test(expected = IllegalArgumentException.class)
    ...
    * Attempt to mock unmockable JRE interface.
    *
    * @param mockComparator the mock comparator
    */
   @Test(expected = IllegalArgumentException.class)
    ...
    * Attempt to mock unmockable JRE interface.
    *
    * @param mockQueue the mock queue
    */
   @Test(expected = IllegalArgumentException.class)
    ...
    * Attempt to mock unmockable JRE interface.
    *
    * @param mockEnumeration the mock enumeration
    */
   @Test(expected = IllegalArgumentException.class)
    ...
    * Attempt to mock unmockable JRE interface.
    *
    * @param mockIterator the mock iterator
    */
   @Test(expected = IllegalArgumentException.class)
    ...
    * Attempt to mock unmockable JRE interface.
    *
    * @param mockMapEntry the mock map entry
    */
   @Test(expected = IllegalArgumentException.class)
  ...
  * @return the duration
  */
 @SuppressWarnings("Since15") Duration getDuration(); }
