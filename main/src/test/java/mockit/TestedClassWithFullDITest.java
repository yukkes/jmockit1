...
public final class TestedClassWithFullDITest
{
    ...
    */
   public static class SecondLevelDependency { /** The common dependency. */
 CommonDependency commonDependency; }
    ...
    */
   public static class AnotherTestedClass { /** The sub obj. */
 ...
 Person person; }
    ...
    */
   static class ClassWithDataSourceField { /** The ds. */
 DataSource ds; }
    ...
    */
   static class ClassWithJPAFields { /** The em factory. */
 EntityManagerFactory emFactory; /** The em. */
 EntityManager em; }

   /**
    * Instantiate class with non annotated JPA fields.
    *
    * @param tested6 the tested 6
    */
   @Test
