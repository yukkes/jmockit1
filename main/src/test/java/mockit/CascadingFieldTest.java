...
public final class CascadingFieldTest
{
 ...
 C getC(); }
   ...
   /**
    * Record ambiguous expectation with multiple cascading candidates followed by expectation recorded on first candidate.
    *
  ...
  * @return the t
  */
 @SuppressWarnings("unchecked") T value() { return (T) Long.valueOf(123); } }
