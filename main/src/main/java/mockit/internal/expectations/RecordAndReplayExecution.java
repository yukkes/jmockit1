...
public final class RecordAndReplayExecution
{
   ...
   public static Object recordOrReplay(
      ...
      if (executingTest.isShouldIgnoreMockingCallbacks()) {
         ...
         return defaultReturnValue(executingTest, mock, classDesc, mockDesc, genericSignature, executionMode, mockArgs);
      }
   ...
   private Object getResultForConstructor(@Nonnull Object mock, @Nonnull ExecutionMode executionMode) {
      return
         ...
         executionMode == ExecutionMode.Partial && replayPhase == null ||
         TestRun.getExecutingTest().isInjectableMock(mock) ?
            null : Void.class;
   }
